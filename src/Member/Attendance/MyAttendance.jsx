                    ...
                    <div className="grid grid-cols-7 gap-4">
                        ...
                        {dates.map(date => {
                            ...
                            return (
                                <div
                                    key={date}
                                    className={`aspect-square flex flex-col items-center justify-center rounded-[24px] border ${visited ? 'bg-primary border-primary text-white shadow-lg shadow-violet-100' : 'border-slate-100 bg-slate-50/30 text-slate-700 hover:border-violet-200'} transition-all duration-300 group cursor-pointer relative`}
                                >
                                    <span className={`text-sm font-black transition-colors ${visited ? 'text-white' : 'group-hover:text-primary'}`}>{date}</span>
