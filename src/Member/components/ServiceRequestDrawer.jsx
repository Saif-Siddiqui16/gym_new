...
const ServiceRequestDrawer = ({ isOpen, onClose, onSubmit, memberData, initialType }) => {
    ...
    return (
            ...
            footer={
                <div className="flex gap-3 w-full">
                    ...
                    <Button
                        ...
                        className="flex-1 py-3 rounded-xl bg-primary hover:bg-primary-hover shadow-lg shadow-violet-200 border-transparent font-bold text-white flex items-center justify-center gap-2"
                    >
        ...
        >
            <form id="request-form" onSubmit={handleSubmit} className="p-8 space-y-8">
                <div className="bg-primary-light p-6 rounded-[24px] border border-violet-100 flex gap-4 text-violet-800 text-sm font-medium leading-relaxed">
                ...
                <div className="space-y-3">
                    ...
                    <select
                        className="w-full h-14 px-6 rounded-2xl bg-slate-50 border-2 border-slate-100 focus:border-primary outline-none font-bold text-sm transition-all text-slate-700"
                        value={type}
                ...
                <div className="space-y-3">
                    ...
                    <textarea
                        className="w-full p-6 rounded-2xl bg-slate-50 border-2 border-slate-100 focus:border-primary outline-none font-medium text-sm transition-all resize-none h-48 placeholder:text-slate-300 text-slate-700"
