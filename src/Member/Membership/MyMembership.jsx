            ...
            <div className="grid grid-cols-1 gap-8 max-w-full">
                ...
                {!isRequestsPage && (
                    <div className="space-y-6">
                        ...
                        <Card className="p-10 border-2 border-slate-100 shadow-sm rounded-3xl bg-white overflow-hidden relative border-l-8 border-l-primary">
                        ...
                        <Card className="p-10 border-2 border-slate-100 shadow-sm rounded-3xl bg-white">
                            <div className="flex flex-col items-center justify-center text-center space-y-6">
                                ...
                                <button
                                    ...
                                    className="px-10 h-14 border-2 border-primary text-primary rounded-[20px] text-[10px] font-black uppercase tracking-[0.2em] shadow-xl shadow-violet-100/20 hover:bg-primary-light transition-all flex items-center gap-3"
                                >
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex flex-col items-center justify-center min-w-[70px] h-[90px] rounded-2xl border-2 transition-all duration-300 shrink-0 ${isActive
                                        ? 'bg-primary border-primary text-white shadow-lg shadow-violet-100 scale-105'
                        ...
                        {loadingSlots ? (
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {availableSlots.map((slot) => (
                                    <div key={slot.id} className="group relative bg-white p-6 rounded-3xl border-2 border-slate-100 hover:border-violet-200 transition-all hover:shadow-xl hover:shadow-primary-light">
                                        <div className="flex items-center justify-between gap-4">
                                            <div className="flex items-center gap-5">
                                                <div className="w-14 h-14 rounded-2xl bg-primary-light flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                                                    <Activity size={24} />
                                                </div>
                                                <div>
                                            ...
                                            <button
                                                ...
                                                className="px-6 h-12 bg-slate-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-primary disabled:opacity-50 transition-all active:scale-95"
                                            >
