        ...
        <div className="fade-in max-w-full mx-auto space-y-4 sm:space-y-6 p-4 sm:p-6">
            ...
            <Card>
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 border-b border-gray-100 pb-4 sm:pb-6 mb-4 sm:mb-6">
                    ...
                    >
                        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-violet-900"></div>
                        Razorpay
                    </button>
                    <button
                ...
                <form className="space-y-4 sm:space-y-6" onSubmit={handleSave}>
                    ...
                    {!isReadOnly && (
                        <div className="flex justify-end pt-2 sm:pt-4">
                            <Button variant="primary" className="w-full sm:w-auto px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg sm:rounded-xl shadow-lg shadow-violet-200">
