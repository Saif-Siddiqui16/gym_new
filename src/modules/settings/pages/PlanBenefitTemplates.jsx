    ...
    return (
        <div className="space-y-8 p-0 md:p-6 animate-fadeIn">
            ...
            <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-primary via-primary to-primary rounded-3xl blur-3xl opacity-10 pointer-events-none"></div>
                <div className="relative bg-white/80 backdrop-blur-md rounded-[32px] shadow-2xl shadow-purple-500/10 border border-white/50 p-6 sm:p-10">
                    <div className="flex items-start gap-5">
                        ...
                        <div>
                            ...
                            {selectedBranch && (
                                <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 bg-primary-light rounded-xl text-xs font-black text-primary">
            ...
            <div className="bg-white rounded-[28px] border border-slate-100 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-50 flex items-center justify-between">
                    ...
                    <span className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest ${selectedPlans.length > 0 ? 'bg-primary text-white' : 'bg-slate-100 text-slate-500'}`}>
                            ...
                            <div
                                ...
                                className={`group relative rounded-2xl border-2 p-5 transition-all duration-200 ${
                                    exists
                                        ...
                                        : selected
                                        ? 'border-primary bg-primary-light/30 shadow-md -translate-y-0.5 cursor-pointer'
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-3 mb-1">
                                            ...
                                            <span className={`shrink-0 px-2.5 py-1 rounded-lg text-xs font-black ${selected ? 'bg-primary text-white' : 'bg-slate-50 border border-slate-100 text-primary'}`}>
            ...
            <div className="bg-white rounded-[28px] border border-slate-100 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-50 flex items-center justify-between">
                    ...
                    <span className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest ${selectedBenefits.length > 0 ? 'bg-primary text-white' : 'bg-slate-100 text-slate-500'}`}>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {benefit.bookable && (
                                                <span className="px-2 py-0.5 bg-primary-light text-primary rounded text-[9px] font-black uppercase tracking-widest border border-violet-100">
                                                    Bookable
                                                </span>
                                            )}
                                        </div>
                ...
                <button
                    ...
                    className={`w-full py-5 rounded-2xl font-black uppercase tracking-widest text-sm transition-all flex items-center justify-center gap-3 ${
                        totalSelected > 0 && !importing
                            ? 'bg-gradient-to-r from-primary to-primary text-white shadow-2xl shadow-purple-500/25 hover:scale-[1.01] active:scale-[0.99]'
