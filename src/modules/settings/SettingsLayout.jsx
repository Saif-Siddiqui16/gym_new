...
const SettingsLayout = ({ role }) => {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-full lg:h-[calc(100vh-112px)] overflow-hidden bg-gradient-to-br from-slate-50 via-white to-primary-light/30 font-black">
            {/* Sidebar */}
            <aside className="w-full lg:w-80 bg-white/80 backdrop-blur-md border-r border-slate-100 flex-shrink-0 h-full overflow-y-auto scrollbar-hide shadow-sm sticky top-0 lg:static">
                <div className="p-6 lg:p-8">
                    <div className="flex items-center gap-4 mb-8">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-primary flex items-center justify-center text-white shadow-lg shadow-violet-200 transition-all duration-300 hover:scale-110 hover:rotate-6">
            ...
            {/* Content Area */}
            <div className="flex-1 min-w-0 bg-[#F8FAFC] h-full overflow-y-auto">
