...
const TrainerAssignment = () => {
    ...
    return (
        <div className="fade-in px-4 sm:px-6 lg:px-8 py-6" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <Card className="mb-8 border-violet-100 bg-primary-light/30">
                    ...
                    return (
                        <div
                            ...
                            className={`group relative p-6 rounded-2xl cursor-pointer transition-all duration-300 border-2 shadow-sm hover:shadow-md ${isSelected
                                ? 'bg-primary-light border-primary shadow-violet-100'
                        ...
                        >
                            ...
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors duration-300 ${isSelected ? 'bg-primary text-white' : 'bg-gray-100 text-gray-500 group-hover:bg-violet-100 group-hover:text-primary'}`}>
                                <User size={24} />
                            </div>
                            <div className="font-bold text-gray-900 group-hover:text-primary transition-colors duration-300">{trainer.name}</div>
