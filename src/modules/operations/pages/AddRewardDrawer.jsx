            ...
            <div className="flex-1  p-6 space-y-6">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-bold text-slate-900 focus:border-primary focus:ring-2 focus:ring-violet-200 transition-all duration-300"
                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-bold text-slate-900 focus:border-primary focus:ring-2 focus:ring-violet-200 transition-all duration-300 pl-10"
                            placeholder="1000"
                        />
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-medium text-slate-900 focus:border-primary focus:ring-2 focus:ring-violet-200 transition-all duration-300 min-h-[120px] resize-none"
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50/50">
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="flex-1 py-3 bg-gradient-to-r from-primary to-primary text-white rounded-xl font-bold hover:shadow-xl hover:shadow-primary/30/50 transition-all duration-300 disabled:opacity-50"
                    >
                        Create Reward
                    </button>
                </div>
