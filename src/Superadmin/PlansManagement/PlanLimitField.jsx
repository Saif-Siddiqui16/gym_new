                    ...
                    {isUnlimited ? (
                        ...
                        <>
                            <input
                                ...
                                className="w-full px-4 py-3 bg-white border-2 border-slate-200 rounded-xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-slate-300"
                            />
                            {unit && (
                ...
                {options && !isUnlimited && (
                    <div className="w-32">
                        <select
                            ...
                            className="w-full h-full px-3 bg-slate-50 border-2 border-slate-100 rounded-xl text-[10px] font-black uppercase tracking-tighter text-slate-600 focus:outline-none focus:border-primary"
                        >
                            {options.map(opt => (
