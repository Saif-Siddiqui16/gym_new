...
const CreatePlan = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-primary-light/30 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-full mx-auto">
                <button
                    onClick={() => navigate('/superadmin/plans/list')}
                    className="group flex items-center text-slate-500 hover:text-primary transition-all mb-8"
                >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    ...
                    <div className="flex items-center gap-3 p-2 bg-primary-light rounded-2xl border border-violet-100">
                        <span className={`text-[10px] font-black uppercase tracking-widest ${formData.status ? 'text-primary' : 'text-slate-400'}`}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 pb-24">
                            ...
                            <div className="p-8 pt-2 space-y-6 animate-in slide-in-from-top-2 duration-300">
                                <div className="space-y-3">
                                    ...
                                    <input
                                        type="text"
                                        name="planName"
                                        className={`w-full px-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl text-lg font-black text-slate-800 placeholder:text-slate-300 focus:outline-none focus:bg-white focus:border-primary transition-all ${errors.planName ? 'border-red-500 bg-white' : ''}`}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="number"
                                                name="price"
                                                className={`w-full pl-12 pr-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl text-2xl font-black text-slate-800 focus:outline-none focus:bg-white focus:border-primary transition-all ${errors.price ? 'border-red-500 bg-white' : ''}`}
                                                placeholder="9999"
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <select
                                            className="w-full px-6 py-5 bg-slate-50 border-2 border-transparent rounded-2xl text-sm font-black text-slate-600 uppercase tracking-widest focus:outline-none focus:bg-white focus:border-primary transition-all"
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea
                                        name="description"
                                        className="w-full px-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl text-sm font-bold text-slate-600 focus:outline-none focus:bg-white focus:border-primary transition-all min-h-[120px] resize-none"
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-8">
                        ...
                        <button
                            ...
                            className="flex-[2] py-5 bg-gradient-to-r from-primary to-primary text-white rounded-3xl text-sm font-black uppercase tracking-widest shadow-2xl shadow-violet-200 flex items-center justify-center gap-3 hover:shadow-violet-400 hover:-translate-y-1 active:translate-y-0 transition-all"
                        >
                            <Save size={24} />
