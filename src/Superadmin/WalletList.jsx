                        ...
                        <tbody className="bg-white divide-y divide-gray-100">
                            {currentMembers.length > 0 ? (
                                currentMembers.map((record) => {
                                    ...
                                    return (
                                        <tr key={record.id} className="hover:bg-primary-light/30 transition-all duration-300 group">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right" data-label="Action">
                                                <button
                                                    ...
                                                    className="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-primary bg-primary-light rounded-lg hover:bg-violet-100 transition-all duration-300"
                                                >
                            ...
                            <nav className="isolate inline-flex -space-x-px rounded-md shadow-xs" aria-label="Pagination">
                                ...
                                {[...Array(totalPages)].map((_, idx) => (
                                    <button
                                        ...
                                        className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold focus:z-20 transition-all ${currentPage === idx + 1 ? 'z-10 bg-primary text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary' : 'text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0'}`}
                                    >
                                        {idx + 1}
                                    </button>
                                ))}
