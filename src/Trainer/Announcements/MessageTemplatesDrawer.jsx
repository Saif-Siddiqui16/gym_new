...
const MessageTemplatesDrawer = ({ isOpen, onClose }) => {
    ...
    const footer = (
        <div className="p-4 bg-primary-light/50 rounded-2xl border-2 border-dashed border-violet-100 flex items-center justify-between overflow-hidden">
            ...
            {!isAddingTemplate && (
                <button
                    ...
                    className="px-4 py-2 bg-white text-primary rounded-xl font-black text-[10px] uppercase tracking-widest shadow-sm hover:shadow-md transition-all flex items-center gap-2"
                >
    ...
    return (
        ...
        >
            <div className="flex flex-col h-full bg-slate-50/20">
                    ...
                    <div className="p-8 space-y-6 bg-white border-b border-slate-100 shrink-0 rounded-t-3xl">
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full h-12 pl-12 pr-4 bg-slate-50 border-2 border-slate-100 rounded-2xl text-sm font-semibold focus:border-primary transition-all outline-none"
                                value={searchTerm}
                ...
                <div className="flex-1  px-6 py-8 space-y-6 custom-scrollbar">
                    {isAddingTemplate ? (
                        ...
                        filteredTemplates.map((template) => (
                            <div key={template.id} className="group bg-white rounded-3xl p-6 border-2 border-slate-100 transition-all hover:border-violet-100 hover:shadow-xl hover:shadow-primary/30/5">
                                ...
                                <div className="bg-slate-50 rounded-2xl p-4 mb-4 border border-slate-50 group-hover:bg-white group-hover:border-primary-light transition-all">
                                ...
                                <button
                                    ...
                                    className={`w-full py-3.5 rounded-xl flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all border-2 ${copiedId === template.id
                                        ...
                                        : 'bg-white border-slate-100 text-slate-900 hover:border-primary hover:text-primary'
                                        }`}
                                >
