...
const StaffAttendanceLog = () => {
    ...
    const getRoleBadge = (role) => {
        const roleColors = {
            'Trainer': 'from-purple-500 to-primary shadow-purple-500/50',
            'Receptionist': 'from-primary to-primary shadow-primary/30/50',
            'Cleaning': 'from-teal-500 to-teal-600 shadow-teal-500/50',
            'Manager': 'from-primary to-primary shadow-primary/30/50'
        };
                    ...
                    <div className="hidden md:block overflow-x-auto">
                        <table className="w-full text-left text-sm">
                            <thead className="bg-slate-50/50 border-b border-slate-100">
                                <tr>
                                    <th className="px-6 py-4 font-black text-slate-400 uppercase tracking-wider text-xs hover:text-primary transition-colors duration-300 cursor-pointer">Staff Name</th>
                                    <th className="px-6 py-4 font-black text-slate-400 uppercase tracking-wider text-xs hover:text-primary transition-colors duration-300 cursor-pointer">Role</th>
                                    <th className="px-6 py-4 font-black text-slate-400 uppercase tracking-wider text-xs hover:text-primary transition-colors duration-300 cursor-pointer">Shift Time</th>
                                        ...
                                        <tr key={record.id} className="group/row hover:bg-gradient-to-r hover:from-primary-light/50 hover:to-purple-50/50 transition-all duration-300 cursor-pointer hover:shadow-md">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-100 to-violet-100 text-primary flex items-center justify-center shadow-md transition-all duration-500 group-hover/row:scale-125 group-hover/row:bg-gradient-to-br group-hover/row:from-purple-500 group-hover/row:to-primary group-hover/row:text-white group-hover/row:shadow-xl group-hover/row:rotate-6">
                                            ...
                                            <td className="px-6 py-4 text-slate-600 text-sm font-semibold group-hover/row:text-primary transition-colors duration-300">
                                                {record.shift || '-'}
                                            </td>
