        ...
        >
            <form onSubmit={handleSubmit} className="flex flex-col h-full">
                <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                    ...
                    {/* Header Card */}
                    <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-[24px] p-6 text-white shadow-lg relative overflow-hidden">
                    ...
                    <div className="space-y-3">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl font-bold text-slate-800 focus:bg-white focus:border-violet-500 transition-all placeholder:font-medium"
                    ...
                    <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${formData.isScheduled ? 'bg-violet-100 text-violet-600' : 'bg-slate-200 text-slate-400'}`}>
                                    <Calendar size={20} />
                                </div>
                                <div>
                        ...
                        {formData.isScheduled && (
                            <div className="animate-in fade-in slide-in-from-top-2 pt-2">
                                <input
                                    type="datetime-local"
                                    className="w-full px-4 py-3 bg-white border-2 border-violet-100 rounded-xl font-bold text-slate-700 focus:border-violet-500 transition-all"
                ...
                <div className="shrink-0 p-4 bg-white border-t border-slate-100 flex gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
                    ...
                    <button
                        ...
                        className="flex-[2] px-4 py-3 bg-violet-600 text-white rounded-xl text-sm font-bold hover:bg-violet-700 hover:shadow-lg hover:shadow-purple-500/30 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
