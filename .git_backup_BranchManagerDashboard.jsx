...
const BranchManagerDashboard = () => {
    ...
    return (
        <div className="saas-page pb-page animate-fadeIn">
            ...
            {/* Top Statistic Cards ΓÇö Row 1: Core Metrics */}
            ...
            {/* Secondary KPI Cards ΓÇö Row 2: Analytics Metrics */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <StatsCard
                    title="Net Profit (Store)"
                    value={`Γé╣${(extraStats.netProfit || 0).toLocaleString()}`}
                    icon={TrendingUp}
                    subtitle="Sale ΓÇô Cost Price"
                    trend="Monthly"
                    trendDirection="up"
                    color="success"
                />
            ...
            {/* ΓöÇΓöÇΓöÇ Smart AIoT Access Control (same as Admin) ΓöÇΓöÇΓöÇ */}
            <SmartAIoTSummary />
                                ...
                                <div key={i} className="flex-1 flex flex-col items-center justify-end h-full group/bar cursor-pointer" style={{ paddingBottom: '24px' }}>
                                    ...
                                    {item.value > 0 && (
                                        <span className="text-[9px] font-black text-primary mb-0.5 leading-none">
                                            Γé╣{item.value >= 1000 ? (item.value / 1000).toFixed(1) + 'k' : item.value}
                                        </span>
                                    )}
                                    {/* Bar */}
                                    <div
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 transition-all duration-200 md:hover:shadow-xl md:hover:-translate-y-0.5">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 text-center">
                            ...
                            <h4 className="text-2xl font-black text-slate-900">Γé╣{receivables.toLocaleString()}</h4>
                        </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-white rounded-[24px]  border border-slate-100 shadow-xl flex items-center gap-4 transition-all duration-200 md:hover:shadow-2xl md:hover:-translate-y-0.5 group">
                        ...
                        <div>
                            ...
                            <h4 className="text-2xl font-black text-slate-800">Γé╣{financials.collection.cash.toLocaleString()}</h4>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-[24px]  border border-slate-100 shadow-xl flex items-center gap-4 transition-all duration-200 md:hover:shadow-2xl md:hover:-translate-y-0.5 group">
                        ...
                        <div>
                            ...
                            <h4 className="text-2xl font-black text-slate-800">Γé╣{financials.collection.upi.toLocaleString()}</h4>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-[24px]  border border-slate-100 shadow-xl flex items-center gap-4 transition-all duration-200 md:hover:shadow-2xl md:hover:-translate-y-0.5 group">
                        ...
                        <div>
                            ...
                            <h4 className="text-2xl font-black text-slate-800">Γé╣{financials.collection.card.toLocaleString()}</h4>
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-900 rounded-[24px]  shadow-xl flex items-center gap-4 transition-all duration-200 md:hover:shadow-2xl md:hover:-translate-y-0.5 group text-white border-2 border-slate-800">
                        ...
                        <div>
                            ...
                            <h4 className="text-2xl font-black italic">
                                Γé╣{(financials.collection.cash + financials.collection.upi + financials.collection.card - financials.expenses.today).toLocaleString()}
                            </h4>
                        </div>
                    </div>
                </div>
