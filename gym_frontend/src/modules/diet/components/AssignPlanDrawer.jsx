...
const AssignPlanDrawer = ({ isOpen, onClose, onAssign, planName }) => {
    ...
    // Mock members data - In real app, this comes from state/assigned members
    const MOCK_MEMBERS = [
        { id: 'M-101', name: 'John Doe', currentPlan: 'Fat Loss Shred' },
        { id: 'M-102', name: 'Jane Smith', currentPlan: null },
        { id: 'M-103', name: 'Mike Monitor', currentPlan: 'Lean Bulk' },
        { id: 'M-104', name: 'Alice Cooper', currentPlan: null },
        { id: 'M-105', name: 'Bob Builder', currentPlan: 'Maintenance' },
    ];
                ...
                <div className="flex-1 overflow-y-auto pr-2 space-y-6">
                    ...
                    <div className="bg-slate-50 p-5 rounded-[24px] border border-slate-100 space-y-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <textarea className="w-full h-20 bg-white border border-slate-200 rounded-xl px-4 py-2 text-sm font-medium focus:border-indigo-500 outline-none resize-none" placeholder="Add specific instructions for the member..." value={notes} onChange={e => setNotes(e.target.value)} />
                        </div>
                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-semibold text-gray-400">
                                                {member.currentPlan ? `Current: ${member.currentPlan}` : 'No active plan'}
                                            </p>
                                        </div>
                                    </div>
